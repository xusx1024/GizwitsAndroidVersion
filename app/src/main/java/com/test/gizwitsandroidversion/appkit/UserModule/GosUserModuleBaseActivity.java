...
public class GosUserModuleBaseActivity extends GosBaseActivity {
  ...
  private GizWifiSDKListener gizWifiSDKListener = new GizWifiSDKListener() {
    ...
    public void didNotifyEvent(com.gizwits.gizwifisdk.enumration.GizEventType eventType,
        Object eventSource, GizWifiErrorCode eventID, String eventMessage) {
   ...
   *
   * @param result 错误码
   * @param cloudServiceInfo 云端服务信息
   */
  protected void didGetCurrentCloudService(GizWifiErrorCode result,
      java.util.concurrent.ConcurrentHashMap<String, String> cloudServiceInfo) {
  }

  protected void didNotifyEvent(com.gizwits.gizwifisdk.enumration.GizEventType eventType,
      Object eventSource, GizWifiErrorCode eventID, String eventMessage) {
