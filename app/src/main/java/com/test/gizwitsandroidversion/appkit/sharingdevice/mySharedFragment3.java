...
public class mySharedFragment3 extends Fragment {
  ...
  @Override public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    if (GosConstant.mydeviceSharingInfos.size() == 0) {
      ...
      shareddeviceproductname.setText(
          productname + " " + getResources().getString(R.string.sharedto));
    }
  ...
  protected void quitAlert(Context context, String username, final int uid2) {
    final Dialog dialog =
        new AlertDialog.Builder(getActivity()).setView(new EditText(getActivity())).create();
        ...
        case 0:
          ...
          if (diff > 0) {
            ...
            delete3name.setOnClickListener(new OnClickListener() {
              ...
              @Override public void onClick(View arg0) {
                GizDeviceSharing.sharingDevice(token, myid,
                    GizDeviceSharingWay.GizDeviceSharingByNormal,
