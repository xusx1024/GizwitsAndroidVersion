package com.test.gizwitsandroidversion.appkit.CommonModule;
...
import com.test.gizwitsandroidversion.appkit.MessageCenter;
...
public class GosBaseActivity extends FragmentActivity {
  ...
  /** Toast time */
  public int toastTime = Toast.LENGTH_LONG;
  /** 存储器 */
  ...
  public void setActionBar(Boolean HBE, Boolean DSHE, int Title) {
    ...
    ssTitle.setSpan(new ForegroundColorSpan(GosDeploy.setNavigationBarTextColor()), 0,
        ssTitle.length(), Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
