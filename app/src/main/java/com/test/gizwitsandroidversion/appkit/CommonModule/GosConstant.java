...
public class GosConstant {
	...
	public static List<GizDeviceSharingInfo>
      mydeviceSharingInfos = new ArrayList<GizDeviceSharingInfo>();

	public static List<GizDeviceSharingInfo>
      newmydeviceSharingInfos = new ArrayList<GizDeviceSharingInfo>();
