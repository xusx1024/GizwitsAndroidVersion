package com.test.gizwitsandroidversion.appkit.ConfigModule;
...
import com.test.gizwitsandroidversion.appkit.CommonModule.WifiAutoConnectManager;
import com.test.gizwitsandroidversion.appkit.utils.NetUtils;
import com.test.gizwitsandroidversion.appkit.view.RoundProgressBar;
import java.util.Timer;
import java.util.TimerTask;

@SuppressLint("HandlerLeak") public class GosConfigCountdownActivity
  ...
  Handler handler = new Handler() {
    public void handleMessage(Message msg) {
      ...
      switch (key) {
        ...
        case SUCCESSFUL:
          Toast.makeText(GosConfigCountdownActivity.this, R.string.configuration_successful,
              toastTime).show();
          finish();
          break;

        case FAILED:
          Toast.makeText(GosConfigCountdownActivity.this, msg.obj.toString(), toastTime).show();
          Intent intent =
              new Intent(GosConfigCountdownActivity.this, GosConfigFailedActivity.class);
        ...
        case OFFTIME:
          GizWifiSDK.sharedInstance()
              .setDeviceOnboarding(workSSID, workSSIDPsw, GizWifiConfigureMode.GizWifiSoftAP,
                  presentSSID, 60, null);
          break;
  ...
  private void readyToSoftAP() {
    ...
    WifiAutoConnectManager.WifiCipherType cipherType =
        WifiAutoConnectManager.getCipherType(GosConfigCountdownActivity.this, softSSID);
   ...
   * @param productKey PK
   */
  protected void didSetDeviceOnboarding(GizWifiErrorCode result, String mac, String did,
      String productKey) {
