...
import com.test.gizwitsandroidversion.appkit.CommonModule.NoScrollViewPager;
...
import com.test.gizwitsandroidversion.appkit.sharingdevice.messageCenterActivity;
...
public class GosMainActivity extends GosDeviceModuleBaseActivity {
  ...
  @SuppressWarnings("deprecation") LocalActivityManager manager = null;
  ...
  @SuppressWarnings("deprecation") @Override public void onCreate(Bundle savedInstanceState) {
    ...
    AndPermission.with(this)
        ...
        .rationale(new RationaleListener() {
          ...
          @Override public void showRequestPermissionRationale(int arg0, Rationale arg1) {
  ...
  @SuppressWarnings("deprecation") private void initHandler() {
   ...
   * 初始化动画
   */
  @SuppressWarnings("deprecation") private void InitImageView() {
    ...
    switch (item.getItemId()) {
      ...
      case R.id.action_addDevice:
        if (!checkNetwork(GosMainActivity.this)) {
          Toast.makeText(GosMainActivity.this, R.string.network_error, Toast.LENGTH_SHORT).show();
        } else {
   ...
   * 通过activity获取视图
   */
  @SuppressWarnings("deprecation") private View getView(String id, Intent intent) {
