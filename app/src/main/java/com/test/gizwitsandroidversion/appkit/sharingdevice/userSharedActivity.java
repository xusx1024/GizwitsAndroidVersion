...
public class userSharedActivity extends GosBaseActivity {
  ...
  private void initView() {
    ...
    usersharedtext.setText(
        getResources().getString(R.string.shared) + productname + getResources().getString(
            R.string.friends));
  }
  ...
  public void usershared(View v) {
    ...
    builder.setPositiveButton(getResources().getString(R.string.confirm), new OnClickListener() {
      ...
      @Override public void onClick(DialogInterface arg0, int arg1) {
        ...
        GizDeviceSharing.sharingDevice(token, did, GizDeviceSharingWay.GizDeviceSharingByNormal,
            usernametext, gizuser);
  ...
  @Override protected void onResume() {
    ...
    GizDeviceSharing.setListener(new GizDeviceSharingListener() {
      ...
      public void didSharingDevice(GizWifiErrorCode result, String deviceID, int sharingID,
        ...
        if (result.ordinal() == 0) {
          Toast.makeText(userSharedActivity.this, getResources().getString(R.string.alawyssend), 1)
              .show();
          finish();
        } else {
          Toast.makeText(userSharedActivity.this, getResources().getString(R.string.send_failed1),
              2).show();
        }
      }
    });
