...
@SuppressLint("HandlerLeak") public class GosAirlinkConfigCountdownActivity
  ...
  Handler handler = new Handler() {
    public void handleMessage(Message msg) {
      ...
      switch (key) {
        ...
        case FAILED:
          Toast.makeText(GosAirlinkConfigCountdownActivity.this, msg.obj.toString(), toastTime)
              .show();
          Intent intent =
              new Intent(GosAirlinkConfigCountdownActivity.this, GosDeviceReadyActivity.class);
  ...
  private void startAirlink() {
    GizWifiSDK.sharedInstance()
        .setDeviceOnboarding(workSSID, workSSIDPsw, GizWifiConfigureMode.GizWifiAirLink, null, 60,
            modeList);
